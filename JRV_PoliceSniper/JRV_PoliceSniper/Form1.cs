...
namespace JRV_PoliceSniper
{
    public partial class Form1 : Form
    {
        ...
        private void goodGuyClick(int window)
        {
            timer1.Stop();
            ...
            if (window == 1) { window1.Visible = true; }
            if (window == 2) { window2.Visible = true; }
            if (window == 3) { window3.Visible = true; }
            if (window == 4) { window4.Visible = true; }
            if (window == 5) { window5.Visible = true; }
            if (window == 6) { window6.Visible = true; }
            if (window == 7) { window7.Visible = true; }
            if (window == 8) { window8.Visible = true; }
            if (window == 9) { window9.Visible = true; }
            if (window == 10) { window10.Visible = true; }
            if (window == 11) { window11.Visible = true; }
            if (window == 12) { window12.Visible = true; }
            ...
            hiscoreText.Text = "Current High Score: " + hiscore;
            //hiscoreText.Visible = true;
        }
